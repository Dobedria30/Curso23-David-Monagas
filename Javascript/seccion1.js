...
//Tipos de datos
let number = 42; // numero (numeros enteros)
let float = 3.14; // Numero de punto (numeros decimales)
let string = "Hola, mundo"; // Cadena de texto
let boolean = true; // Booleano (true o false / verdadero o falso)
...
//Ejercicos para practicar la lógica (operadores lógicos)
...
let dia = 3; // Supongamos que 1 es Lunes, 2 es Martes, etc.
switch (dia) {
  case 1:
    console.log("Lunes");
    break;
